...
Begin VB.Form frmReportConfig 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cboFontName 
         ...
         Width           =   3525
      End
      Begin prjMtpTax.uctlTextBox txtPaperWidth 
         Height          =   435
         Left            =   1860
         TabIndex        =   2
         Top             =   1530
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackgroundStyle=   2
      End
      Begin prjMtpTax.uctlTextBox uctlTextBox1 
         Height          =   435
         Left            =   6000
         TabIndex        =   1
         Top             =   1080
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtPaperHeight 
         Height          =   435
         Left            =   6000
         TabIndex        =   3
         Top             =   1530
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginBottom 
         Height          =   435
         Left            =   6000
         TabIndex        =   5
         Top             =   1980
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginHeader 
         Height          =   435
         Left            =   1860
         TabIndex        =   8
         Top             =   2880
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginFooter 
         Height          =   435
         Left            =   6000
         TabIndex        =   9
         Top             =   2880
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginTop 
         Height          =   435
         Left            =   1860
         TabIndex        =   4
         Top             =   1980
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginLeft 
         Height          =   435
         Left            =   1860
         TabIndex        =   6
         Top             =   2430
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox uctlTextBox8 
         Height          =   435
         Left            =   1860
         TabIndex        =   10
         Top             =   3330
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMarginRight 
         Height          =   435
         Left            =   6000
         TabIndex        =   7
         Top             =   2430
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox uctlTextBox10 
         Height          =   435
         Left            =   6000
         TabIndex        =   11
         Top             =   3330
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtHeadOffset 
         Height          =   435
         Left            =   1860
         TabIndex        =   14
         Top             =   4620
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtDummyOffset 
         Height          =   435
         Left            =   6000
         TabIndex        =   15
         Top             =   4620
