...
Begin VB.Form frmLogin 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.OptionButton radThai 
         ...
         Width           =   2025
      End
      Begin prjSamuiTour.uctlTextBox txtPassword 
         Height          =   375
         Left            =   1380
         TabIndex        =   2
         Top             =   690
         ...
         _ExtentY        =   0
      End
      Begin prjSamuiTour.uctlTextBox txtUserName 
         Height          =   375
         Left            =   1380
         TabIndex        =   1
         Top             =   300
...
'   End If
   ...
   Call InitDialogButton(cmdOK, MapText("ตกลง"))
   Call InitDialogButton(cmdCancel, MapText("ยกเลิก"))
   
   Call InitDialogHeader(lblHeader, MapText("กรุณาล็อคอินเข้าระบบ"))
End Sub
