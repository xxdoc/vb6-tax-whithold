...
Dim OKClick As Boolean
   ...
   If Area = 1 Then
      frmAddEditSchedule.HeaderText = MapText("เพิ่มตารางรถ")
   ElseIf Area = 2 Then
      frmAddEditSchedule.HeaderText = MapText("เพิ่มตารางเรือ")
   End If
...
Dim OKClick As Boolean
   ...
   If Area = 1 Then
      frmAddEditSchedule.HeaderText = MapText("เแก้ไขตารางรถ")
   ElseIf Area = 2 Then
      frmAddEditSchedule.HeaderText = MapText("เแก้ไขตารางเรือ")
   End If
   frmAddEditSchedule.Area = Area
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 1950
   Col.Caption = MapText("เลขที่ใบรับ")
   ...
   Col.Width = 2190
   If Area = 1 Then
      Col.Caption = MapText("หมายเลขรถ")
   ElseIf Area = 2 Then
      Col.Caption = MapText("หมายเลขเรือ")
   End If
   
   Set Col = GridEX1.Columns.Add '5
   Col.Width = 2505
   Col.Caption = MapText("โซน")
   
   Set Col = GridEX1.Columns.Add '6
   Col.Width = 3495
   Col.Caption = MapText("ผู้รับ")
...
Private Sub InitFormLayout()
   ...
   If Area = 1 Then
      Call InitNormalLabel(lblResourceNo, MapText("หมายเลขรถ"))
   ElseIf Area = 2 Then
      Call InitNormalLabel(lblResourceNo, MapText("หมายเลขเรือ"))
   End If
   Call InitNormalLabel(lblSlipNo, MapText("เลขที่ใบจอง"))
   Call InitNormalLabel(lblTravelDate, MapText("วันที่เดินทาง"))
   Call InitNormalLabel(lblSchduleNo, MapText("เลขที่ใบรับ"))
   Call InitNormalLabel(lblZone, MapText("โซน"))
