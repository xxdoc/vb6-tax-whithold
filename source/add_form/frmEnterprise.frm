...
Begin VB.Form frmEnterprise 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cboOrderBy 
         ...
         Width           =   2955
      End
      Begin prjMtpTax.uctlTextBox txtCustomerName 
         Height          =   435
         Left            =   1560
         TabIndex        =   1
         Top             =   1410
      ...
      End
      Begin prjMtpTax.uctlTextBox txtCustomerCode 
         Height          =   435
         Left            =   1560
         TabIndex        =   0
         Top             =   960
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmEnterprise.frx":3884
         ButtonStyle     =   3
      End
   End
End
...
Dim OKClick As Boolean
   ...
   If Not VerifyAccessRight("MAIN_ENTERPRISE_ADD") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If

   frmAddEditEnterprise.HeaderText = MapText("เพิ่มข้อมูลบริษัท")
...
Dim ID As Long
   ...
   If Not VerifyAccessRight("MAIN_ENTERPRISE_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   ...
   If Not glbDaily.DeleteEnterprise(ID, IsOK, True, glbErrorLog) Then
...
Dim OKClick As Boolean
   ...
   If Not VerifyAccessRight("MAIN_ENTERPRISE_QUERY") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   ...
   frmAddEditEnterprise.HeaderText = MapText("แก้ไขข้อมูลบริษัท")
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call InitEnterpriseOrderBy(cboOrderBy)
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_Enterprise.ENTERPRISE_ID = -1
      m_Enterprise.SHORT_NAME = PatchWildCard(txtCustomerCode.Text)
      m_Enterprise.ENTERPRISE_NAME = PatchWildCard(txtCustomerName.Text)
      m_Enterprise.OrderBy = cboOrderBy.ItemData(Minus2Zero(cboOrderBy.ListIndex))
      m_Enterprise.OrderType = cboOrderType.ItemData(Minus2Zero(cboOrderType.ListIndex))
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 7035
   Col.Caption = MapText("ชื่อบริษัท")

   Set Col = GridEX1.Columns.Add '4
   Col.Width = 2190
   Col.Caption = MapText("เลขประจำตัวผู้เสียภาษี")
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblCustomerName, MapText("ชื่อบริษัท"))
   Call InitNormalLabel(lblCustomerCode, MapText("รหัสบริษัท"))
...
Dim RealIndex As Long
   ...
   Values(1) = m_Enterprise.ENTERPRISE_ID
   Values(2) = m_Enterprise.SHORT_NAME
   Values(3) = m_Enterprise.ENTERPRISE_NAME
   Values(4) = m_Enterprise.TAX_ID
   Exit Sub
