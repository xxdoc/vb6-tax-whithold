...
Begin VB.Form frmSlipBooking 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmSlipBooking.frx":27A2
         Column(2)       =   "frmSlipBooking.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmSlipBooking.frx":290E
         FormatStyle(2)  =   "frmSlipBooking.frx":2A6A
         FormatStyle(3)  =   "frmSlipBooking.frx":2B1A
         FormatStyle(4)  =   "frmSlipBooking.frx":2BCE
         FormatStyle(5)  =   "frmSlipBooking.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmSlipBooking.frx":2D5E
      End
      ...
      Begin prjMtpTax.uctlDate uctlTravelDate 
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtVocher 
         Height          =   435
         Left            =   1560
         TabIndex        =   4
         Top             =   1830
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmSlipBooking.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmSlipBooking.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmSlipBooking.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmSlipBooking.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmSlipBooking"
...
Dim OKClick As Boolean
   ...
   frmAddEditSlipBooking.HeaderText = MapText("เพิ่มใบจอง")
   frmAddEditSlipBooking.ShowMode = SHOW_ADD
   Load frmAddEditSlipBooking
   frmAddEditSlipBooking.Show 1
   
   OKClick = frmAddEditSlipBooking.OKClick
   
   Unload frmAddEditSlipBooking
   Set frmAddEditSlipBooking = Nothing
...
Private Sub cmdClear_Click()
   txtSlipNo.Text = ""
   txtVocher.Text = ""
   uctlBookingDate.ShowDate = -1
   uctlTravelDate.ShowDate = -1
   cboVehicleType.ListIndex = -1
...
Dim ID As Long
   ...
   If Not VerifyAccessRight("CRM_ORDER_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim OKClick As Boolean
   ...
   If Not VerifyAccessRight("CRM_ORDER_QUERY") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   ...
   frmAddEditSlipBooking.ID = ID
   frmAddEditSlipBooking.HeaderText = MapText("เแก้ไขการจอง")
   frmAddEditSlipBooking.ShowMode = SHOW_EDIT
   Load frmAddEditSlipBooking
   frmAddEditSlipBooking.Show 1
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadMaster(cboVehicleType, , MASTER_BRANCH)
      Call LoadMaster(cboDestination, , MASTER_DEST)
      
      Call InitSlipBookingOrderBy(cboOrderBy)
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_Customer.CUSTOMER_CODE = PatchWildCard(txtSlipNo.Text)
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2325
   Col.Caption = MapText("วันที่จอง")

   Set Col = GridEX1.Columns.Add '4
   Col.Width = 2190
   Col.Caption = MapText("วันที่เดินทาง")
   
   Set Col = GridEX1.Columns.Add '5
   Col.Width = 5025
   Col.Caption = MapText("ปลายทาง")
