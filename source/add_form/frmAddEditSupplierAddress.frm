...
Begin VB.Form frmAddEditSupplierAddress 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cboCountry 
         ...
         Width           =   2685
      End
      Begin prjMtpTax.uctlTextBox txtSoi 
         Height          =   435
         Left            =   1710
         TabIndex        =   1
         Top             =   720
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtHomeNo 
         Height          =   435
         Left            =   1710
         TabIndex        =   0
         Top             =   270
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtVillage 
         Height          =   435
         Left            =   1710
         TabIndex        =   3
         Top             =   1620
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtMoo 
         Height          =   435
         Left            =   1710
         TabIndex        =   2
         Top             =   1170
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtRoad 
         Height          =   435
         Left            =   1710
         TabIndex        =   4
         Top             =   2070
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtAmphur 
         Height          =   435
         Left            =   1710
         TabIndex        =   6
         Top             =   2970
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtDistrict 
         Height          =   435
         Left            =   1710
         TabIndex        =   5
         Top             =   2520
      ...
      Begin prjMtpTax.uctlTextBox txtProvince 
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtFax 
         Height          =   435
         Left            =   1710
         TabIndex        =   11
         Top             =   4770
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtPhone 
         Height          =   435
         Left            =   1710
         TabIndex        =   10
         Top             =   4320
         ...
         _ExtentY        =   767
      End
      Begin prjMtpTax.uctlTextBox txtZipcode 
         Height          =   435
         Left            =   6900
         TabIndex        =   8
         Top             =   3390
